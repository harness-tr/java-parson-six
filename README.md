...
```
app/src/main/java/com/java-parson-six/HelloController.java
```
...
**Important:** Replace the image placeholder `gcr.io/YOUR_PROJECT_ID/java-parson-six:latest` with your actual GCR or Artifact Registry path.
